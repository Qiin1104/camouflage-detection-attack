...
if __name__ == '__main__':
    ...
    parser.add_argument('--trainsize', type=int, default=512, help='training dataset size,candidate=352,512,704')
    ...
    parser.add_argument('--train_path', type=str, default='./dataset2/YH/train', help='path to train dataset')
    parser.add_argument('--test_path', type=str, default='./dataset2/YH/test', help='path to testing dataset')
    ...
    # ---- build models ----
    torch.cuda.set_device("cuda:0")  # set your gpu device
    model = IdeNet().cuda()

    if opt.load is not None:
        pretrained_dict = torch.load(opt.load, map_location='cuda:0')
