...
class PolypObjDataset(data.Dataset):
    def __init__(self, image_root, gt_root, trainsize):
        ...
        # get filenames
        self.images = [image_root + f for f in os.listdir(image_root) if f.endswith('.jpg') or f.endswith('.jpeg') or f.endswith('.png')]
...
class test_dataset:
    def __init__(self, image_root, gt_root, testsize):
        ...
        self.images = sorted(self.images)#hjc 文件重排序
        self.gts = sorted(self.gts)
        self.transformbin = transforms.Compose([
        ...
        self.transform = transforms.Compose([
            transforms.Resize((self.testsize, self.testsize)),
            transforms.ToTensor(),
            transforms.Normalize([0.405257, 0.405257, 0.405257], [0.168808, 0.168808, 0.168808])
        ])#[0.44867, 0.43396, 0.328925], [0.270546, 0.262004, 0.279058] cod3k
    ...
    def load_data(self):
        ...
        gts1 = self.transformbin(gt).unsqueeze(0)
        ...
        return image, gt, name, np.array(image_for_post), gts1
